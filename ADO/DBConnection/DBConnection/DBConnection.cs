...
namespace DBConnection
{
    public partial class DBConnection : Form
    {
        ...
        private void connectMS_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void disconnectMS_Click(object sender, EventArgs e)
        {
            if (connection.State == ConnectionState.Open)
            {
                connection.Close();
        ...
        private async void asyncMS_Click(object sender, EventArgs e)
        {
            try
            {
                if (connection.State != ConnectionState.Open)
        ...
        {
            connectMS.Enabled = (e.CurrentState == ConnectionState.Closed);
            asyncMS.Enabled = (e.CurrentState == ConnectionState.Closed);
            disconnectMS.Enabled = (e.CurrentState == ConnectionState.Open);
        }

        private void conListMS_Click(object sender, EventArgs e)
        {
